...
public class Button extends Component {
	...
	public void render() {
		...
		if (image != "") {
			...
			Screen.renderSpriteIgnoringCamera(image, getLocation().clone().add((int) getDimensions().getWidth() / 2, (int) getDimensions().getHeight() / 2).subtract((int) sprite.getWidth() / 2, (int) sprite.getHeight() / 2));
		} else {
